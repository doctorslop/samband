        ...
        >
          <div className="logo-icon">
            {theme === 'radar' ? (
              ...
              <svg className="logo-icon-default-svg" viewBox="0 0 90 90" aria-hidden="true">
                <path d="M50.619 30.076C39.471 32.628 27.781 42.6 27.781 54.522l3.371 18.432h38.934V54.522C70.086 42.6 61.766 32.628 50.619 30.076z" fill="#fb4239"/>
                <path d="M50.619 30.076c-1.807-.414-3.686-.64-5.619-.64-13.854 0-25.086 11.231-25.086 25.086v18.432h11.237V54.522c0-11.922 8.319-21.894 19.468-24.446z" fill="#e21717"/>
                <path d="M73.61 72.954H28.824v13.916h48.618V76.786c0-2.117-1.715-3.832-3.832-3.832z" fill="#caedff"/>
                <path d="M31.072 78.637v-5.683H16.39c-2.116 0-3.832 1.716-3.832 3.832v8.382c0 2.116 1.716 3.832 3.832 3.832h57.22c2.116 0 3.832-1.716 3.832-3.832v-.546H37.057c-3.305 0-5.985-2.68-5.985-5.985z" fill="#76c2e0"/>
                <path d="M70.086 73.954H19.915c-.552 0-1-.447-1-1V54.521c0-14.384 11.702-26.085 26.085-26.085s26.086 11.702 26.086 26.085v18.433c0 .553-.447 1-1 1zM20.915 71.954h48.171V54.521c0-13.281-10.805-24.085-24.086-24.085-13.281 0-24.085 10.805-24.085 24.085v17.433z" fill="#000"/>
                <path d="M73.61 90H16.39c-2.665 0-4.833-2.168-4.833-4.832v-8.382c0-2.664 2.168-4.832 4.833-4.832h57.22c2.664 0 4.832 2.168 4.832 4.832v8.382C78.442 87.832 76.274 90 73.61 90zM16.39 73.954c-1.562 0-2.833 1.271-2.833 2.832v8.382c0 1.562 1.271 2.832 2.833 2.832h57.22c1.562 0 2.832-1.271 2.832-2.832v-8.382c0-1.562-1.271-2.832-2.832-2.832H16.39z" fill="#000"/>
                <path d="M45 16.246c-.552 0-1-.448-1-1V1c0-.552.448-1 1-1s1 .448 1 1v14.246c0 .552-.448 1-1 1z" fill="#000"/>
                <path d="M20.111 26.555c-.256 0-.512-.098-.707-.293L9.331 16.189c-.391-.391-.391-1.023 0-1.414s1.023-.391 1.414 0l10.073 10.073c.391.391.391 1.023 0 1.414-.195.196-.451.293-.707.293z" fill="#000"/>
                <path d="M69.889 26.555c-.256 0-.512-.098-.707-.293-.391-.391-.391-1.023 0-1.414l10.073-10.073c.391-.391 1.023-.391 1.414 0s.391 1.023 0 1.414L70.596 26.262c-.196.196-.451.293-.707.293z" fill="#000"/>
                <path d="M45 51.515c-3.297 0-5.969 2.673-5.969 5.969v15.47h11.939v-15.47c0-3.297-2.672-5.969-5.97-5.969z" fill="#fec007"/>
                <path d="M50.97 73.954H39.031c-.552 0-1-.447-1-1v-15.47c0-3.843 3.126-6.97 6.969-6.97s6.97 3.127 6.97 6.97v15.47c0 .553-.448 1-1 1zm-10.939-2h9.939v-14.47c0-2.74-2.229-4.97-4.97-4.97s-4.969 2.229-4.969 4.97v14.47z" fill="#000"/>
              </svg>
            )}
          </div>
