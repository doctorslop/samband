...
export const TYPE_STYLES: Record<string, TypeStyle> = {
  ...
  'Mord/dråp': { icon: '🔪', color: '#dc2626', class: 'event-type--mord' },
  'Rattfylleri': { icon: '🍺', color: '#ef4444', class: 'event-type--ratta' },
  'Vapen': { icon: '🔫', color: '#dc2626', class: 'event-type--default' },
  'Våld': { icon: '👊', color: '#ef4444', class: 'event-type--misshandel' },
  'Hot': { icon: '⚠️', color: '#ef4444', class: 'event-type--default' },
  'Sexualbrott': { icon: '⛔', color: '#f43f5e', class: 'event-type--default' },
  'brott': { icon: '⚖️', color: '#fcd34d', class: 'event-type--default' },
